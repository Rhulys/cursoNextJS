...
export const metadata: Metadata = {
    ...
    description: "Perfil Rhulyanderson Sander | Daly Games sua plataforma de jogos!"
}
            ...
            <Container>
                <section className="mt-8 mb-6 flex flex-col items-center justify-between relative gap-3 sm:flex-row">
                    <div className="w-full flex items-center gap-4 text-lg flex-col sm:flex-row justify-center sm:justify-normal">
                        ...
                        <h1 className="font-bold text-2xl">Rhulyanderson Sander</h1>
                    </div>

                    <div className="sm:absolute top-0 right-0 gap-3 flex items-center justify-center mt-2">
                        <button className="bg-gray-700 px-4 py-3 rounded-lg text-white">Configuracoes</button>
